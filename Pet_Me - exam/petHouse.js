function solveClasses() {
    ...
    class Cat extends Pet {
        ...
        toString() {
            ...
            output.push(`${this.name} is a cat with ${this.insideHabits}`);
    ...
    class Dog extends Pet {
        ...
        toString() {
            ...
            output.push(super.toString());
            output.push("Main information:");
            output.push(`${this.name} is a dog with need of ${this.runningNeeds}km running every day and ${this.trainability} trainability.`);
            return output.join("\n");
        }
    }
